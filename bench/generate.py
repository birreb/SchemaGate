...
SUPPLIERS = [
    {"name": "Northgate Supply Co.", "locale": "sv", "vat": "SE556000000001", "ccy": "SEK",
     "address": ["Industrivägen 8", "633 42 Eskilstuna"], "terms": 30, "bank": "Bankgiro 5432-1098",
     "reg": "556000-0000", "customer_no": "K-10442", "accent": (31, 78, 121)},
    {"name": "Björkman & Söner AB", "locale": "sv", "vat": "SE556234567801", "ccy": "SEK",
     "address": ["Hamngatan 2", "411 06 Göteborg"], "terms": 30, "bank": "Bankgiro 320-9917",
     "reg": "556234-5678", "customer_no": "40871", "accent": (140, 60, 30)},
    {"name": "Lindqvist Elektronik AB", "locale": "sv", "vat": "SE556876543201", "ccy": "SEK",
     "address": ["Kvarnvägen 19", "587 31 Linköping"], "terms": 14, "bank": "Plusgiro 48 22 11-3",
     "reg": "556876-5432", "customer_no": "C00213", "accent": (0, 110, 100)},
    {"name": "Rheinwerk Maschinenbau GmbH", "locale": "de", "vat": "DE811234567", "ccy": "EUR",
     "address": ["Industriestraße 44", "50735 Köln"], "terms": 30,
     "bank": "IBAN DE89 3704 0044 0532 0130 00", "reg": "HRB 12345 Amtsgericht Köln",
     "customer_no": "20077", "accent": (60, 60, 60)},
    {"name": "Hofmann Verpackungen GmbH", "locale": "de", "vat": "DE129876543", "ccy": "EUR",
     "address": ["Am Hafen 3", "20457 Hamburg"], "terms": 14,
     "bank": "IBAN DE02 2005 0550 1234 5678 90", "reg": "HRB 98765 Amtsgericht Hamburg",
     "customer_no": "K-3391", "accent": (170, 100, 20)},
    {"name": "Kestrel Components Ltd", "locale": "gb", "vat": "GB123456789", "ccy": "GBP",
     "address": ["Unit 4, Riverside Park", "Sheffield S9 2AB"], "terms": 30,
     "bank": "Sort code 12-34-56, account 87654321", "reg": "Company no. 04512345",
     "customer_no": "HALV01", "accent": (90, 40, 110)},
    {"name": "Albion Fasteners Ltd", "locale": "gb", "vat": "GB987654321", "ccy": "GBP",
     "address": ["12 Mill Lane", "Leeds LS1 4DT"], "terms": 30,
     "bank": "Sort code 40-11-22, account 11223344", "reg": "Company no. 07788990",
     "customer_no": "A-2210", "accent": (0, 90, 60)},
    {"name": "Great Lakes Tooling Inc.", "locale": "us", "vat": None, "ccy": "USD",
     "address": ["2200 Commerce Dr", "Grand Rapids, MI 49503"], "terms": 30,
     "ein": "38-2947103", "bank": "Wire: Fifth Third Bank, acct 9988776655", "reg": "",
     "customer_no": "CUST-5521", "accent": (180, 30, 30)},
    {"name": "Fjordkraft Komponenter AS", "locale": "no", "vat": "NO987654321MVA", "ccy": "NOK",
     "address": ["Sjøgata 11", "5003 Bergen"], "terms": 30, "bank": "Kontonr 1234.56.78903",
     "reg": "987 654 321", "customer_no": "8802", "accent": (20, 60, 140)},
]

PRODUCTS = [
    "Steel bracket 40x40", "M8 hex bolt, zinc", "Bearing 6204-2RS", "Hydraulic hose 3/8in",
    "Control panel enclosure", "Cable gland M20", "Servo motor 750W", "Safety relay 24V",
    "Pneumatic cylinder 32x100", "Linear guide rail 600mm", "Installation labour",
    "Site commissioning", "Freight pallet", "Terminal block 2.5mm", "Proximity sensor M12",
]

LOCALES: dict[str, dict[str, Any]] = {
    "sv": {
        "title": "FAKTURA", "number": "Fakturanummer", "date": "Fakturadatum",
        "due": "Förfallodatum", "delivery": "Leveransdatum", "po": "Ert ordernummer",
        "vat": "Momsreg.nr", "bill_to": "Fakturamottagare", "desc": "Beskrivning",
        "qty": "Antal", "unit": "À-pris", "amount": "Belopp", "net": "Summa netto",
        "discount": "Rabatt", "shipping": "Frakt", "tax": "Moms", "total": "Att betala",
        "rate_col": "Moms %", "statement": "KONTOUTDRAG", "customer": "Kundnummer", "date_short": "Datum",
        "pos": "Pos", "sku": "Art.nr", "unit_name": "st", "hour": "tim", "type": "Typ",
        "invoice_word": "Faktura", "credit_word": "Kreditnota", "balance": "Saldo",
        "status": "Status", "paid": "Betald", "unpaid": "Obetald", "page": "Sida 1 av 1",
        "months": ["januari", "februari", "mars", "april", "maj", "juni", "juli", "augusti",
                   "september", "oktober", "november", "december"],
        "thousands": " ", "decimal": ",", "ccy_after": True,
    },
    "de": {
        "title": "RECHNUNG", "number": "Rechnungsnummer", "date": "Rechnungsdatum",
        "due": "Fällig am", "delivery": "Lieferdatum", "po": "Ihre Bestellnummer",
        "vat": "USt-IdNr.", "bill_to": "Rechnungsempfänger", "desc": "Bezeichnung",
        "qty": "Menge", "unit": "Einzelpreis", "amount": "Betrag", "net": "Nettobetrag",
        "discount": "Rabatt", "shipping": "Versand", "tax": "MwSt", "total": "Rechnungsbetrag",
        "rate_col": "MwSt %", "statement": "KONTOAUSZUG", "customer": "Kundennummer", "date_short": "Datum",
        "pos": "Pos.", "sku": "Art.-Nr.", "unit_name": "Stk", "hour": "Std", "type": "Art",
        "invoice_word": "Rechnung", "credit_word": "Gutschrift", "balance": "Saldo",
        "status": "Status", "paid": "Bezahlt", "unpaid": "Offen", "page": "Seite 1 von 1",
    ...
    "gb": {
        ...
        "due": "Due date", "delivery": "Delivery date", "po": "Your PO",
        "vat": "VAT Reg No", "bill_to": "Bill to", "desc": "Description",
        "qty": "Qty", "unit": "Unit price", "amount": "Amount", "net": "Net total",
        "discount": "Discount", "shipping": "Carriage", "tax": "VAT", "total": "Total due",
        "rate_col": "VAT %", "statement": "STATEMENT OF ACCOUNT", "customer": "Account no", "date_short": "Date",
        "pos": "#", "sku": "Part no", "unit_name": "pcs", "hour": "hrs", "type": "Type",
        "invoice_word": "Invoice", "credit_word": "Credit note", "balance": "Balance",
        "status": "Status", "paid": "Paid", "unpaid": "Outstanding", "page": "Page 1 of 1",
        "months": ["January", "February", "March", "April", "May", "June", "July", "August",
                   "September", "October", "November", "December"],
        "thousands": ",", "decimal": ".", "ccy_after": False,
    },
    "us": {
        "title": "INVOICE", "number": "Invoice #", "date": "Invoice date",
        "due": "Payment due", "delivery": "Ship date", "po": "PO number",
        "vat": "EIN", "bill_to": "Bill to", "desc": "Item",
        "qty": "Qty", "unit": "Rate", "amount": "Amount", "net": "Subtotal",
        "discount": "Discount", "shipping": "Shipping", "tax": "Sales tax", "total": "Balance due",
        "rate_col": "Tax %", "statement": "ACCOUNT STATEMENT", "customer": "Customer ID", "date_short": "Date",
        "pos": "#", "sku": "SKU", "unit_name": "ea", "hour": "hrs", "type": "Type",
        "invoice_word": "Invoice", "credit_word": "Credit memo", "balance": "Balance",
        "status": "Status", "paid": "Paid", "unpaid": "Open", "page": "Page 1 of 1",
        "months": ["January", "February", "March", "April", "May", "June", "July", "August",
                   "September", "October", "November", "December"],
        "thousands": ",", "decimal": ".", "ccy_after": False,
    },
    "no": {
        "title": "FAKTURA", "number": "Fakturanr", "date": "Fakturadato",
        "due": "Forfallsdato", "delivery": "Leveringsdato", "po": "Deres ordrenr",
        "vat": "Org.nr", "bill_to": "Fakturamottaker", "desc": "Beskrivelse",
        "qty": "Antall", "unit": "Pris", "amount": "Beløp", "net": "Sum eks. mva",
        "discount": "Rabatt", "shipping": "Frakt", "tax": "Mva", "total": "Å betale",
        "rate_col": "Mva %", "statement": "KONTOUTSKRIFT", "customer": "Kundenr", "date_short": "Dato",
        "pos": "Pos", "sku": "Varenr", "unit_name": "stk", "hour": "t", "type": "Type",
        "invoice_word": "Faktura", "credit_word": "Kreditnota", "balance": "Saldo",
        "status": "Status", "paid": "Betalt", "unpaid": "Ubetalt", "page": "Side 1 av 1",
...
TAX_RATES = {"sv": [Decimal(25), Decimal(12)], "de": [Decimal(19), Decimal(7)],
             "gb": [Decimal(20), Decimal(5)], "us": [Decimal("8.875")], "no": [Decimal(25)]}
...
class Invoice:
    ...
    def tax_by_rate(self) -> dict[Decimal, Decimal]:
        ...
        return {rate: (base * rate / 100).quantize(CENT, ROUND_HALF_UP)
...
def block(pdf: Pdf, x: float, y: float, lines: list[str], font: str, size: float = 10,
          bold_first: bool = False, h: float = 5, width: float = 0) -> float:
    pdf.set_xy(x, y)
...
def meta_list(pdf: Pdf, x: float, y: float, pairs: list[tuple[str, str]], font: str,
              label_w: float = 50, size: float = 10, colon: bool = False) -> float:
    pdf.set_xy(x, y)
...
def item_cells(inv: Invoice, line: Line, index: int, loc: dict[str, Any], keys: list[str]) -> list[str]:
    values = {
        "pos": str(index + 1),
        "sku": line.sku,
...
HEADERS = {"pos": "pos", "sku": "sku", "desc": "desc", "qty": "qty", "unit_name": "unit_name",
           "price": "unit", "rate": "rate_col", "amount": "amount"}
ALIGN = {"pos": "R", "sku": "L", "desc": "L", "qty": "R", "unit_name": "L", "price": "R",
         "rate": "R", "amount": "R"}
UNIT_HEADER = {"sv": "Enhet", "de": "Einheit", "gb": "Unit", "us": "Unit", "no": "Enhet"}


def items_table(pdf: Pdf, inv: Invoice, keys: list[str], widths: list[float], font: str,
                style: str, accent: tuple[int, int, int] = (230, 230, 230), size: float = 9.5) -> None:
    loc = inv.locale
    headers = [UNIT_HEADER[inv.supplier["locale"]] if key == "unit_name" else loc[HEADERS[key]]
               for key in keys]
    pdf.use(font, "B", size)
    if style == "filled":
...
def totals_rows(inv: Invoice) -> list[tuple[str, str, bool]]:
    ...
    if inv.discount_pct:
        rows.append((f"{loc['discount']} {number(inv.discount_pct, loc)}%",
                     money(-inv.discount, loc, ccy), False))
    if inv.shipping:
...
def totals(pdf: Pdf, inv: Invoice, x: float, font: str, label_w: float = 44, value_w: float = 38,
           style: str = "plain", size: float = 10, accent: tuple[int, int, int] = (0, 0, 0)) -> None:
...
def theme_classic(pdf: Pdf, inv: Invoice) -> None:
    ...
    pdf.ln(5)
    items_table(pdf, inv, ["desc", "qty", "price", "rate", "amount"], [82, 20, 30, 16, 26], f, "filled")
    pdf.ln(3)
...
def theme_band(pdf: Pdf, inv: Invoice) -> None:
    ...
    pdf.ln(4)
    items_table(pdf, inv, ["sku", "desc", "qty", "price", "amount"], [22, 82, 20, 26, 24], f, "boxed")
    pdf.ln(3)
...
def theme_minimal(pdf: Pdf, inv: Invoice) -> None:
    ...
    pdf.use(f, "", 8)
    pdf.ink((120, 120, 120))
    pdf.line_text(" · ".join([sup["name"], *sup["address"], f"{loc['vat']} {sup.get('ein') or sup['vat']}"]), 5)
    pdf.ink()
    pdf.ln(10)
    pdf.use(f, "", 22)
    ...
    pdf.ln(8)
    items_table(pdf, inv, ["desc", "qty", "unit_name", "price", "rate", "amount"],
                [74, 16, 16, 28, 16, 24], f, "caps", size=9)
...
def theme_slip(pdf: Pdf, inv: Invoice) -> None:
    ...
    pdf.ln(10)
    items_table(pdf, inv, ["pos", "desc", "qty", "unit_name", "price", "amount"],
                [10, 84, 18, 16, 24, 22], f, "filled", accent=sup["accent"])
    pdf.ln(3)
    ...
    pdf.set_xy(118, y)
    pdf.use(f, "", 8.5)
    pdf.cell(0, 4.6, "OCR / referens" if sup["locale"] == "sv" else "KID", new_x="LMARGIN", new_y="NEXT")
    pdf.set_x(118)
...
def theme_wordmark(pdf: Pdf, inv: Invoice) -> None:
    ...
    items_table(pdf, inv, ["desc", "qty", "price", "rate", "amount"], [84, 18, 30, 16, 26], f,
...
def theme_mono(pdf: Pdf, inv: Invoice) -> None:
    ...
    for text in buyer_lines(loc):
        row(f"    {text}")
    row("-" * 74)
    header = f"{loc['pos']:>3} {loc['sku']:<7} {loc['desc']:<28} {loc['qty']:>6} {loc['unit']:>12} {loc['amount']:>13}"
    row(header)
    row("-" * 74)
    for index, line in enumerate(inv.lines):
        row(f"{index + 1:>3} {line.sku:<7} {line.description[:28]:<28} {number(line.quantity, loc):>6} "
...
def theme_formal_de(pdf: Pdf, inv: Invoice) -> None:
    ...
    pdf.line_text(f"für die Lieferung vom {date_text(inv.delivered, loc, 'dmy_dot')} erlauben wir uns, "
                  f"Ihnen folgende Positionen in Rechnung zu stellen:", 6)
    pdf.ln(3)
    items_table(pdf, inv, ["pos", "sku", "desc", "qty", "unit_name", "price", "amount"],
                [10, 18, 70, 16, 14, 24, 22], f, "rule")
    pdf.ln(3)
    ccy = sup["ccy"]
    pdf.set_x(110)
    rows = [("Zwischensumme", money(inv.net_lines, loc, ccy), False)]
    if inv.discount_pct:
        rows.append((f"abzgl. Rabatt {number(inv.discount_pct, loc)}%", money(-inv.discount, loc, ccy), False))
    if inv.shipping:
    ...
    pdf.use(f, "", 7.5)
    pdf.ink((90, 90, 90))
    pdf.multi_cell(0, 4, f"{sup['name']} · {' · '.join(sup['address'])} · Geschäftsführer: M. Weber · "
...
def theme_us_letter(pdf: Pdf, inv: Invoice) -> None:
    ...
    items_table(pdf, inv, ["qty", "desc", "price", "amount"], [18, 100, 28, 28], f, "filled", accent=accent)
    pdf.ln(3)
    ccy = sup["ccy"]
    rows = [("Subtotal", money(inv.net_lines, loc, ccy), False)]
    if inv.discount_pct:
        rows.append((f"Discount ({number(inv.discount_pct, loc)}%)", money(-inv.discount, loc, ccy), False))
    if inv.shipping:
...
THEMES = {
    "classic": theme_classic, "band": theme_band, "minimal": theme_minimal, "slip": theme_slip,
    "wordmark": theme_wordmark, "mono": theme_mono, "formal_de": theme_formal_de,
...
def render_statement(supplier: dict[str, Any], entries: list[Invoice | CreditNote],
                     period: dt.date, variant: str) -> bytes:
    ...
    if variant == "balance":
        ...
        for text in [*supplier["address"], f"{loc['vat']}: {supplier.get('ein') or supplier['vat']}"]:
            pdf.line_text(text, 4.6)
        ...
        pdf.line_text("-" * 80, 4.6)
        pdf.line_text(f"{loc['date_short']:<12}{'Ref':<14}{loc['net']:>14}{loc['tax']:>12}{loc['amount']:>14}{loc['balance']:>14}", 4.6)
        pdf.line_text("-" * 80, 4.6)
        balance = Decimal(0)
        for entry in entries:
            if isinstance(entry, Invoice):
                balance += entry.printed_total
                pdf.line_text(f"{date_text(entry.issued, loc, 'iso'):<12}{entry.number:<14}"
                              f"{money(entry.subtotal, loc):>14}{money(entry.tax, loc):>12}"
                              f"{money(entry.printed_total, loc):>14}{money(balance, loc):>14}", 4.6)
            else:
                balance -= entry.amount
                pdf.line_text(f"{date_text(entry.issued, loc, 'iso'):<12}{entry.number:<14}{'':<26}"
                              f"{money(-entry.amount, loc):>14}{money(balance, loc):>14}", 4.6)
        pdf.line_text("=" * 80, 4.6)
        pdf.use(f, "B", 8.5)
    ...
    top = pdf.get_y()
    block(pdf, 18, top, [supplier["name"], *supplier["address"],
                         f"{loc['vat']}: {supplier.get('ein') or supplier['vat']}"], f, bold_first=True)
    block(pdf, 118, top, [loc["bill_to"], BUYER["name"], f"VAT: {BUYER['vat']}",
                          f"{loc['customer']}: {supplier['customer_no']}",
                          f"{date_text(period, loc, 'words')}"], f, bold_first=True)
    ...
    if variant == "plain":
        ...
        headers = [loc["number"], loc["date"], loc["due"], loc["net"], loc["tax"], loc["total"], loc["status"]]
    pdf.use(f, "B", 9)
    ...
    for index, entry in enumerate(entries):
        if isinstance(entry, Invoice):
            ...
            if variant == "plain":
                cells = [entry.number, date_text(entry.issued, loc, "iso"), date_text(entry.due, loc, "iso"),
                         money(entry.subtotal, loc), money(entry.tax, loc), money(entry.printed_total, loc)]
                aligns = ["L", "L", "L", "R", "R", "R"]
            elif variant == "typed":
                cells = [loc["invoice_word"], entry.number, date_text(entry.issued, loc, "iso"),
                         money(entry.subtotal, loc), money(entry.tax, loc), money(entry.printed_total, loc)]
                aligns = ["L", "L", "L", "R", "R", "R"]
            else:
                cells = [entry.number, date_text(entry.issued, loc, "iso"), date_text(entry.due, loc, "iso"),
            ...
            cells = [loc["credit_word"], entry.number, date_text(entry.issued, loc, "iso"),
                     f"({entry.against})", "", money(-entry.amount, loc)]
            aligns = ["L", "L", "L", "R", "R", "R"]
    ...
    pdf.use(f, "", 8.5)
    pdf.multi_cell(0, 4.5, f"All amounts in {ccy}. Please quote the invoice number with each payment. "
                           f"{supplier['bank']}.")
    return bytes(pdf.output())
...
RECEIPT_MERCHANTS = [
    ...
    ("Clas Ohlson Gallerian", "office", ["USB-C kabel 2m", "Anteckningsblock A4", "Batterier AA 8-p"], 25),
...
def make_receipt(rng: random.Random, index: int) -> Receipt:
    ...
    when = dt.datetime(2026, rng.randint(4, 8), rng.randint(1, 28), rng.randint(7, 21), rng.randint(0, 59))
    return Receipt(
        merchant=merchant,
        category=category,
        when=when,
...
def render_receipt(receipt: Receipt, rng: random.Random, style: int) -> bytes:
    ...
    bold = _font(font_name.replace(".ttf", "bd.ttf") if "arial" in font_name else font_name, size + 4)
    y = 40
    margin = 36
    ...
    if style == 2:
        draw.rectangle((margin - 10, y - 10, width - margin + 10, y + 70), outline=(30, 30, 30), width=3)
    ...
    if style == 2:
        ...
        line(f"{number(receipt.tax_rate, loc):<8}{money(receipt.amount - receipt.tax, loc):>10}"
    ...
    if receipt.payment == "card":
        line(("Paid by card ****" if style == 1 else "Betalt: Kort ****") + str(rng.randint(1000, 9999)))
...
TABULAR_HEADERS = {
    "sv": ["Fakturanr", "Leverantör", "Momsreg.nr", "Valuta", "Netto", "Moms", "Att betala",
           "Fakturadatum", "Förfallodatum", "Ert ordernr"],
    "de": ["Rechnungsnr.", "Lieferant", "USt-IdNr.", "Währung", "Nettobetrag", "MwSt",
           "Bruttobetrag", "Rechnungsdatum", "Fällig am", "Bestellnummer"],
    "en": ["Invoice Number", "Supplier", "VAT ID", "Currency", "Subtotal", "Tax", "Total",
           "Issued On", "Due On", "PO Reference"],
}
...
def write_tabular(path: Path, invoices: list[Invoice], headers_key: str, fmt: str,
    ...
    for invoice in invoices:
        ...
        grid.append([
            row["invoice_number"], row["supplier"], row["vat_id"] or "", row["currency"],
            money(invoice.subtotal, loc), money(invoice.tax, loc),
            money(invoice.printed_total, loc), row["issued_on"], row["due_on"],
            row["po_reference"] or "",
        ])
    if fmt == "xlsx":
        book = Workbook()
...
def main() -> None:
    ...
    for index in range(10):
        ...
        if variant in {"typed", "balance"}:
            ...
            credit = CreditNote(
                number=f"CN{sequence + 3}", issued=target.issued + dt.timedelta(days=5),
                amount=(target.printed_total / 4).quantize(CENT), against=target.number,
            )
    ...
    specs = [
        ("sv", "csv", True, 50), ("de", "csv", True, 200), ("en", "xlsx", False, 200),
        ("sv", "xlsx", True, 500), ("de", "csv", True, 1000), ("sv", "csv", True, 2000),
    ]
    start = 5000
